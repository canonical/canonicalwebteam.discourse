...
class BaseParser:
    ...
    def _get_section(self, soup, title_text):
        ...
        for heading in soup(HEADER_REGEX):
            if heading.string is None and heading.a != None and heading.a.next == title_text:
                break
    ...
    def _get_preamble(self, soup, break_on_title):
        ...
        """
        for heading in soup(HEADER_REGEX):
            if heading.string is None and heading.a != None and heading.a.next == break_on_title:
                break
